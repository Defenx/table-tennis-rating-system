...
public class InitializationListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        UserService userService = serviceFactory.createLoginService(bCryptPasswordEncoder);
        ...
        AuthenticationStrategy authenticationStrategy = serviceFactory
                .createUserAuthenticationService(userService, jwtTokenService, authStrategyType);
