...
public final class RouteConstants {
    ...
    public static final String RUN_TOURNAMENT_BY_ID = "/tournament/run/*";
    public static final String LAUNCHED_TOURNAMENTS = "/tournaments";
    public static final String TOURNAMENT_BY_ID = "/tournament/*";
}
