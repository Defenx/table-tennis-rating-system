...
public class StandardAuthenticationStrategy implements AuthenticationStrategy {
    private static final String USER_ID_ATTRIBUTE = AppConfig.getConfigValue(ConfigSection.ATTRIBUTES, "userID");
    private static final String ERROR_MESSAGE_ATTRIBUTE = AppConfig.getConfigValue(ConfigSection.ERRORS, "errorMessage");
